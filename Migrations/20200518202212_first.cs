        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_beneficiario_AspNetUsers_Responsavel",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dataSolic = table.Column<DateTime>(nullable: false),
                    ...
                    Autorizado = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_emprestimo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_emprestimo_AspNetUsers_Autorizado",
                        column: x => x.Autorizado,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_emprestimo_beneficiario_BeneficiarioId",
                        column: x => x.BeneficiarioId,
                        principalTable: "beneficiario",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_emprestimo_situacao_SituacaoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    datavenc = table.Column<DateTime>(nullable: false),
                    datapag = table.Column<DateTime>(nullable: false),
                    Idemprestimo = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_beneficiario_Responsavel",
                table: "beneficiario",
                column: "Responsavel");

            migrationBuilder.CreateIndex(
                name: "IX_emprestimo_Autorizado",
                table: "emprestimo",
                column: "Autorizado");

            migrationBuilder.CreateIndex(
                name: "IX_emprestimo_BeneficiarioId",
                table: "emprestimo",
                column: "BeneficiarioId");

            migrationBuilder.CreateIndex(
                name: "IX_emprestimo_SituacaoId",
                table: "emprestimo",
                column: "SituacaoId");
